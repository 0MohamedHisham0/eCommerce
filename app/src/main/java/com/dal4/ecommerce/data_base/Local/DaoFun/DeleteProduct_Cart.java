...
public class DeleteProduct_Cart extends AsyncTask<Products_Model_Detail, Void, Void> {
    @NonNull
    private List<Products_Model_Detail> list_Cart;
    private Context context;

    public DeleteProduct_Cart(Context context) {
    ...
    protected Void doInBackground(Products_Model_Detail... products_models) {
        ...
        Repository.getCartList_dataBase(context).studentsDao().DeleteProductFromCartList(products_models[0]);
